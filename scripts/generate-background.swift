...
// App icon zone — left (notch pill shape)
...
pillPath.addArc(tangent1End: CGPoint(x: pillX + pillWidth, y: pillY + pillHeight), tangent2End: CGPoint(x: pillX + pillWidth, y: pillY), radius: pillRadius)
pillPath.addLine(to: CGPoint(x: pillX + pillWidth, y: pillY + pillRadius))
pillPath.addArc(tangent1End: CGPoint(x: pillX + pillWidth, y: pillY), tangent2End: CGPoint(x: pillX + pillWidth - pillRadius, y: pillY), radius: pillRadius)
pillPath.addLine(to: CGPoint(x: pillX + pillRadius, y: pillY))
pillPath.addArc(tangent1End: CGPoint(x: pillX, y: pillY), tangent2End: CGPoint(x: pillX, y: pillY + pillRadius), radius: pillRadius)
pillPath.addLine(to: CGPoint(x: pillX, y: pillY + pillHeight - pillRadius))
pillPath.addArc(tangent1End: CGPoint(x: pillX, y: pillY + pillHeight), tangent2End: CGPoint(x: pillX + 4, y: pillY + pillHeight), radius: pillRadius)
pillPath.closeSubpath()
ctx.addPath(pillPath)
ctx.strokePath()

// Applications icon zone — right (folder outline)
